...
class Liquid_Trending_Posts_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__( 'Displays the most trending posts', 'landinghub-core' ) 
		);
		parent::__construct( 'liquid-trending-posts', esc_html__( 'Liquid Themes: Trending Posts', 'landinghub-core' ), $widget_ops );
