...
class Liquid_Newsletter_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'widget_subscribe', 'description' => esc_html__( "Display Newsletter Form", 'landinghub-core' ) );
		parent::__construct( 'liquid-newsllter', esc_html__( 'Liquid Themes: Newsletter Form', 'landinghub-core' ), $widget_ops);
	...
	<div class="widget ld-sf ld-sf--button-block ld-sf--button-solid">
	...
	function form( $instance ) {
		...
		$forms = array_merge_recursive( array( esc_html__( 'Select', 'landinghub-core' ) => '' ) , array_flip( $this->get_mailpoet_forms() ) );
		
		$styles = array(
			'default' => esc_html__( 'Default', 'landinghub-core' ),
			'alt' => esc_html__( 'Style 1', 'landinghub-core'  ),
		);
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'newsletter_id' ) ); ?>"><?php esc_html_e( 'Newsletter:', 'landinghub-core' ); ?></label>
