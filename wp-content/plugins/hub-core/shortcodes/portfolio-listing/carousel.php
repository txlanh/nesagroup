...
echo '<div class="carousel-container ' . $this->get_id() . '">';
	...
	echo '<div class="carousel-items row" data-lqd-flickity=\'{ "equalHeightCells": true, "filters": "#' . $filter_id . '", "prevNextButtons": true, "navArrow": 6, "fullwidthSide": true, "buttonsAppendTo": "#' . $filter_id . '" }\' ' . $this->get_options() . '>';
