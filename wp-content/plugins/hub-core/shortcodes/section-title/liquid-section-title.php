...
class LD_Section_Title extends LD_Shortcode {
	...
	public function __construct() {
		...
		$this->title       = esc_html__( 'Fancy Title', 'landinghub-core' );
		$this->description = esc_html__( 'Heading, subheading and dividers', 'landinghub-core' );
	...
	public function get_params() {
		...
		$custom_title = array(
			...
			array(
				...
				'group' => esc_html__( 'Title', 'landinghub-core' ),
				'dependency' => array(
		...
		$custom_subtitle = array(
			...
			array(
				...
				'group' => esc_html__( 'Subtitle', 'landinghub-core' ),
				'dependency' => array(
		...
		$this->params = array_merge( 
			...
			array(
				...
				array(
					'type'        => 'dropdown',
					'param_name'  => 'add_line',
					'heading'     => esc_html__( 'Add line?', 'landinghub-core' ),
					'description' => esc_html__( 'Add line under section title, to title or under title', 'landinghub-core' ),
					'value' => array(
						esc_html__( 'None', 'landinghub-core' ) => '',
						esc_html__( 'Section Underline', 'landinghub-core' ) => 'underline-fancy-title',
						esc_html__( 'Line near', 'one-ore' ) => 'title-line',
						esc_html__( 'Underline', 'landinghub-core' ) => 'title-underline',
						esc_html__( 'Linethrough', 'landinghub-core' ) => 'title-linethrough',
						esc_html__( 'Double linethrough', 'landinghub-core' ) => 'title-double-linethrough',
					)
				),
				array(
					'type' => 'textfield',
					...
					'description' => esc_html__( 'Add line width in px, for ex. 30px', 'landinghub-core' ),
					'dependency' => array(
						'element' => 'add_line',
				...
				array(
					...
					'heading' => esc_html__( 'Line Radius', 'landinghub-core' ),
					'description' => esc_html__( 'Add line radius in px, for ex. 30px', 'landinghub-core' ),
					'dependency' => array(
						'element' => 'add_line',
						'value' => 'underline-fancy-title'	
					),
				...
				array(
					...
					'description' => esc_html__( 'Pick color for the line', 'landinghub-core' ),
					'dependency' => array(
						'element' => 'add_line',
						'value' => 'underline-fancy-title'	
					),
			...
			array(
				...
				array(
					...
					'heading'    => esc_html__( 'Subtitle Transformation', 'landinghub-core' ),
					'value'      => array(
				...
				array(
					...
					'heading' => esc_html__( 'Subtitle top margin', 'landinghub-core' ),
					'min'         => 0,
					'max'         => 50,
					'step'        => 1,
					'std'         => 0,
				...
				array(
					...
					'heading' => esc_html__( 'Subtitle bottom margin', 'landinghub-core' ),
					'min'         => 0,
					'max'         => 50,
					'step'        => 1,
					'std'         => 10,
				...
				array(
					...
					'heading'     => esc_html__( 'Add line?', 'landinghub-core' ),
					'description' => esc_html__( 'Add line under subtitle, or near title', 'landinghub-core' ),
					'value' => array(
						esc_html__( 'None', 'landinghub-core' ) => '',
						esc_html__( 'Line near', 'one-ore' ) => 'title-line',
						esc_html__( 'Underline', 'landinghub-core' ) => 'title-underline',
			...
			array(
				array(
					'type'       => 'subheading',
					'param_name' => 'sb_heading',
					'heading'    => esc_html__( 'Secondary Options', 'landinghub-core' ),
				),
				array(
					'type'       => 'textarea_html',
				...
				array(
					...
					'heading' => esc_html__( 'Text top margin', 'landinghub-core' ),
					'min'         => 0,
					'max'         => 50,
					'step'        => 1,
					'std'         => 0,
				...
				array(
					...
					'heading' => esc_html__( 'Text bottom margin', 'landinghub-core' ),
					'min'         => 0,
					'max'         => 50,
					'step'        => 1,
					'std'         => 0,
			...
			liquid_get_icon_params( false, '', 'all', array( 'color', 'hcolor', 'size', 'margin-inline-start', 'margin-inline-end' ), 'i_', array() ),
			array(
				array(
					'type'       => 'css_editor',
					'param_name' => 'css',
