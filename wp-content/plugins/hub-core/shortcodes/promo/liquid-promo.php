...
class LD_Promo extends LD_Shortcode { 
	...
	public function __construct() {
		...
		// Properties
		$this->slug        = 'ld_promo';
		$this->title       = esc_html__( 'Fancy Promo', 'landinghub-core' );
		$this->description = esc_html__( 'Add a fancy promo', 'landinghub-core' );
	...
	public function get_params() {
		...
		$params = array(
			...
			array(
				...
				'description' => esc_html__( 'Select alignement for the content in the fancy promo', 'landinghub-core' ),
				'value'       => array(
					esc_html__( 'Left', 'landinghub-core' )  => 'lqd-promo-reverse',
					esc_html__( 'Right', 'landinghub-core' ) => 'lqd-promo-default',
				),
			...
			array(
				...
				'heading'    => esc_html__( 'Show Dynamic Shape', 'landinghub-core' ),
			...
			array(
				...
				'description' => esc_html__( 'Add link to the image.', 'landinghub-core' ),
				'edit_field_class' => 'vc_col-sm-6',
			),
			array(
				'type'       => 'dropdown',
		...
		$design = array(
			...
			array(
				...
				'description' => esc_html__( 'Pick a color overlay', 'landinghub-core' ),
				'edit_field_class' => 'vc_col-sm-6',
				'group'       => esc_html__( 'Design Options', 'landinghub-core' ),
			),
			array(
				...
				'heading'     => esc_html__( 'Dynamic Shape Background', 'landinghub-core' ),
				'description' => esc_html__( 'Pick a background color for dynamic shape ', 'landinghub-core' ),
				'edit_field_class' => 'vc_col-sm-6',
				'group'       => esc_html__( 'Design Options', 'landinghub-core' ),
				'dependency' => array(
