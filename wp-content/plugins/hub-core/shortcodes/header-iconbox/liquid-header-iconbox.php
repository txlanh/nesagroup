...
class LD_Header_Iconbox extends LD_Shortcode {
	...
	public function __construct() {
		...
		$this->title       = esc_html__( 'Header Iconbox', 'landinghub-core' );
		$this->description = esc_html__( 'Header icon box', 'landinghub-core' );
	...
	public function get_params() {
		...
		$general = array(
			...
			array(
				...
				'heading'    => esc_html__( 'Custom title Weight', 'landinghub-core' ),
