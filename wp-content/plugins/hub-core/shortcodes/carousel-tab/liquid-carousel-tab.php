...
* LD_Shortcode
*/
class LD_Carousel_Tab extends LD_Shortcode {
	...
	public function __construct() {
		...
		$this->as_parent     = array( 'only' => 'ld_carousel_section' );
		$this->custom_markup = '<div class="vc_tta-container" data-vc-action="collapse">
			<div class="vc_general vc_tta vc_tta-tabs vc_tta-color-backend-tabs-white vc_tta-style-flat vc_tta-shape-rounded vc_tta-spacing-1 vc_tta-tabs-position-top vc_tta-controls-align-left">
				<div class="vc_tta-tabs-container">'
				. '<ul class="vc_tta-tabs-list">'
					. '<li class="vc_tta-tab" data-vc-tab data-vc-target-model-id="{{ model_id }}" data-element_type="ld_carousel_section"><a href="javascript:;" data-vc-tabs data-vc-container=".vc_tta" data-vc-target="[data-model-id=\'{{ model_id }}\']" data-vc-target-model-id="{{ model_id }}"><span class="vc_tta-title-text">Tab</span></a></li>'
				. '</ul>
				</div>
		...
		$this->default_content = '
			[ld_carousel_section title="Carousel Item"][/ld_carousel_section]
			[ld_carousel_section title="Carousel Item"][/ld_carousel_section]
			[ld_carousel_section title="Carousel Item"][/ld_carousel_section]';
	...
	public function get_params() {
		...
		$options = array(
			...
			array(
				'type'        => 'dropdown',
				'heading'     => esc_html__( 'Middle Align Content', 'landinghub-core' ),
				'description' => esc_html__( 'Set the content alignment to the middle.', 'landinghub-core' ),
				'param_name'  => 'middlealigncontent',
				'value'       => array(
					esc_html__( 'Disable', 'landinghub-core' )  => '',
					esc_html__( 'Enable', 'landinghub-core' ) => 'yes'
				),
				'dependency'  => array(
					'element' => 'equalheightcells',
					'value'   => array( 'yes' )
				),
				'edit_field_class' => 'vc_col-sm-6'
			),
		...
		$nav = array(
			...
			array(
				'type' => 'dropdown',
				'param_name' => 'mobile_navhalign',
				'heading' => esc_html__( 'Mobile Navigation Arrows Alignment', 'landinghub-core' ),
				'description' => esc_html__( 'Select alignment for the navigation on mobile.', 'landinghub-core' ),
				'value' => array(
					esc_html__( 'Left', 'landinghub-core' ) => 'carousel-nav-mobile-left',
					esc_html__( 'Center', 'landinghub-core' ) => 'carousel-nav-mobile-center',
					esc_html__( 'Right', 'landinghub-core' ) => 'carousel-nav-mobile-right',
				),
				'dependency'  => array(
					'element' => 'prevnextbuttons',
					'value'   => 'yes'
				),
				'std' => 'carousel-nav-mobile-center',
				'edit_field_class' => 'vc_col-sm-6',
				'group' => esc_html__( 'Nav', 'landinghub-core' ),
			),
			array(
			...
			array(
				'type'        => 'textfield',
				'param_name'  => 'iconsize',
				'heading'     => esc_html__( 'Navigation Arrow Icon Size', 'landinghub-core' ),
				'description' => esc_html__( 'Custom Icon Size, for ex. 18px', 'landinghub-core' ),
				'dependency'  => array(
					'element' => 'navarrow',
					'value'   => 'custom'
				),
			...
			array(
				...
				'value'       => array(
					...
					esc_html__( 'Center', 'landinghub-core' )   => 'carousel-dots-center',
			...
			array(
				...
				'value'       => array(
					...
					esc_html__( 'Style 4', 'landinghub-core' ) => 'carousel-dots-style4',
				),
				'dependency'  => array(
					'element' => 'dots_type',
					'value'   => 'dots'
			...
			array(
				...
				'heading'     => esc_html__( 'Dots Hover/Active Color', 'landinghub-core' ),
				'description' => esc_html__( 'Pick hover and active color for the page dots', 'landinghub-core' ),
				'edit_field_class' => 'vc_col-sm-6',
				'group'       => esc_html__( 'Nav', 'landinghub-core' ),
				'dependency'  => array(
					'element' => 'pagenationdots',
			...
			array(
				'type'        => 'textfield',
				'param_name'  => 'mobile_dots_bottom_offset',
				'std'         => '15px',
				'heading'     => esc_html__( 'Dots Bottom Offset', 'landinghub-core' ),
				'description' => esc_html__( 'Dots offset from bottom edge', 'landinghub-core' ),
				'edit_field_class' => 'vc_col-sm-6',
				'dependency'  => array(
					'element' => 'mobile_dots_position',
					'value'   => 'carousel-dots-mobile-inside'
				),
				'group' => esc_html__( 'Nav', 'landinghub-core' ),
			),
			array(
				'type'        => 'textfield',
				'param_name'  => 'mobile_dots_bottom_offset_outside',
				'std'         => '1.5em',
				'heading'     => esc_html__( 'Dots Bottom Offset', 'landinghub-core' ),
				'description' => esc_html__( 'Dots offset from bottom edge', 'landinghub-core' ),
				'edit_field_class' => 'vc_col-sm-6',
				'dependency'  => array(
					'element' => 'mobile_dots_position',
					'value'   => 'carousel-dots-mobile-outside'
				),
				'group' => esc_html__( 'Nav', 'landinghub-core' ),
			),
			array(
	...
	public function before_output( $atts, &$content ) {
		...
		global $liquid_carousel_tabs;

		$liquid_carousel_tabs = array();

		//parse ld_tab_section shortcode
		do_shortcode( $content );

		$atts['items'] = $liquid_carousel_tabs;
	...
	protected function get_animation_opts() {
		...
		$opts['clearProps'] = 'opacity,transform-origin';
	...
	protected function generate_css() {
		...
		if( !empty( $columns ) ) {
			...
			if( !empty( $columns['spacing_xs'] ) ) {
				...
				$elements[liquid_implode( '.carousel-container%1$s .carousel-items' )]['margin-inline-start']  = '-' . $columns['spacing_xs'];
				$elements[liquid_implode( '.carousel-container%1$s .carousel-items' )]['margin-inline-end'] = '-' . $columns['spacing_xs'];
			}
			...
			if( isset( $columns['sm'] ) || !empty( $columns['spacing_sm'] ) ) {
				...
				$queries_css .= '@media (min-width: 768px) {';
					...
					if( !empty( $columns['spacing_sm'] ) ) {
						...
						$queries_css .= '.carousel-container' . $id . ' .carousel-items { margin-inline-start:-' . $columns['spacing_sm'] . ';margin-inline-end:-' . $columns['spacing_sm'] . ';}';
					}
			...
			if( isset( $columns['md'] ) || !empty( $columns['spacing_md'] ) ) {
				...
				$queries_css .= '@media (min-width: 992px) {';
					...
					if( !empty( $columns['spacing_md'] ) ) {
						...
						$queries_css .= '.carousel-container' . $id . ' .carousel-items { margin-inline-start:-' . $columns['spacing_md'] . ';margin-inline-end:-' . $columns['spacing_md'] . ';}';
					}
				$queries_css .= '}';
			}
			if( isset( $columns['lg'] ) || !empty( $columns['spacing_lg'] ) ) {
				...
				$queries_css .= '@media (min-width: 1200px) {';
					...
					if( !empty( $columns['spacing_lg'] ) ) {
						...
						$queries_css .= '.carousel-container' . $id . ' .carousel-items { margin-inline-start:-' . $columns['spacing_lg'] . ';margin-inline-end:-' . $columns['spacing_lg'] . ';}';
					}
				$queries_css .= '}';
			}
		}
		...
		if( !empty( $nav_arrow_color ) ) {
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button svg' )]['fill'] = $nav_arrow_color;
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button' )]['color'] = $nav_arrow_color;
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button.previous:after' )]['background'] = $nav_arrow_color;
		}
		if( !empty( $nav_arrow_color_hover ) ) {
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button:hover svg' )]['fill'] = $nav_arrow_color_hover;
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button:hover' )]['color'] = $nav_arrow_color_hover;
		}
		...
		if( !empty( $nav_border_color ) ) {
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button' )]['border-color'] = $nav_border_color;
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button.previous:after' )]['background-color'] = $nav_border_color;
		}
		if( !empty( $nav_border_hcolor ) ) {
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button:hover' )]['border-color'] = $nav_border_hcolor;
		}
		if( !empty( $nav_bg_color ) ) {
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button' )]['background'] = $nav_bg_color;
		}
		if( !empty( $nav_bg_hcolor ) ) {
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button:before' )]['background'] = $nav_bg_hcolor;
		}
		if( !empty( $shapesize ) ) {
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button' ) ]['width'] = $shapesize .' !important';
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button' ) ]['height'] = $shapesize .' !important';
		}
		if( !empty( $iconsize ) ) {
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button' ) ]['font-size'] = $iconsize .' !important';
		}
		if( !empty( $shapeheight ) ) {
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button' ) ]['height'] = $shapeheight .' !important';
		}
		if( !empty( $shapewidth ) ) {
			$elements[liquid_implode( '%1$s.carousel-nav .flickity-prev-next-button' ) ]['width'] = $shapewidth .' !important';
		}


		if( 'carousel-dots-style3' ===  $dots_style ) {
			if( !empty( $dots_bg_color ) ) {
				$elements[liquid_implode( '%1$s.carousel-dots .dot' )]['color'] = $dots_bg_color;
				$elements[liquid_implode( '%1$s.carousel-dots .dot' )]['background-color'] = $dots_bg_color;
				$elements[liquid_implode( '%1$s.carousel-dots .dot.is-selected' )]['background-color'] = 'transparent';
				$elements[liquid_implode( '%1$s.carousel-dots .dot:hover' )]['background-color'] = 'transparent';
			}
			if( !empty( $dots_bg_hcolor ) ) {
				$elements[liquid_implode( '%1$s.carousel-dots .dot:hover:before' )]['color'] = $dots_bg_hcolor;
				$elements[liquid_implode( '%1$s.carousel-dots .dot.is-selected:before' )]['color'] = $dots_bg_hcolor;
			}
		}
		else if ( 'numbers' !== $dots_type ) {
			if( !empty( $dots_bg_color ) ) {
				$elements[liquid_implode( '%1$s.carousel-dots .dot' )]['background'] = $dots_bg_color;
				$elements[liquid_implode( '%1$s.carousel-dots .dot' )]['border-color'] = $dots_bg_color;
				$elements[liquid_implode( '%1$s.carousel-dots .dot' )]['color'] = $dots_bg_color;
			}
			if( !empty( $dots_bg_hcolor ) ) {
				$elements[liquid_implode( '%1$s.carousel-dots .dot.is-selected, %1$s.carousel-dots .dot:hover' )]['background'] = $dots_bg_hcolor;
				$elements[liquid_implode( '%1$s.carousel-dots .dot.is-selected, %1$s.carousel-dots .dot:hover' )]['border-color'] = $dots_bg_hcolor;
				$elements[liquid_implode( '%1$s.carousel-dots .dot.is-selected, %1$s.carousel-dots .dot:hover' )]['color'] = $dots_bg_hcolor;
			}
		}
		else {
			if( !empty( $dots_bg_color ) ) {
		...
		if ( $dots_top_offset || $dots_right_offset || $dots_bottom_offset || $dots_left_offset ) {
			$elements[liquid_implode( '%1$s.carousel-dots' )]['position'] = 'relative';
			if ( 'carousel-dots-inside' === $dots_position ) {
				$elements[liquid_implode( '%1$s.carousel-dots' )]['position'] = 'absolute';
			}
		}

		if ( !empty($dots_top_offset) ) {
			$elements[liquid_implode( '%1$s.carousel-dots' )]['top'] = $dots_top_offset;
		}
		if ( !empty($dots_right_offset) ) {
			$elements[liquid_implode( '%1$s.carousel-dots' )]['right'] = $dots_right_offset;
		}
		if ( !empty($dots_bottom_offset) ) {
			$elements[liquid_implode( '%1$s.carousel-dots' )]['bottom'] = $dots_bottom_offset;
		}
		if ( !empty($dots_left_offset) ) {
			$elements[liquid_implode( '%1$s.carousel-dots' )]['left'] = $dots_left_offset;
		}

		if( !empty( $dotscustomsize ) ) {
			$elements[liquid_implode( '%1$s.carousel-dots .dot' )]['width'] = $dotscustomsize;
			$elements[liquid_implode( '%1$s.carousel-dots .dot' )]['height'] = $dotscustomsize;
		}
		if ( !empty( $dotscustomsize_height ) ) {
			$elements[liquid_implode( '%1$s.carousel-dots .dot' )]['height'] = $dotscustomsize_height;
		}

		if ( ! empty( $mobile_dots_bottom_offset ) && '15px' !== $mobile_dots_bottom_offset ) {
			$elements[liquid_implode( '%1$s.carousel-dots-mobile.carousel-dots-mobile-inside' )]['bottom'] = $mobile_dots_bottom_offset;
		}
		if ( ! empty( $mobile_dots_bottom_offset_outside ) && '1.5em' !== $mobile_dots_bottom_offset_outside ) {
			$elements[liquid_implode( '%1$s.carousel-dots-mobile.carousel-dots-mobile-outside .flickity-page-dots' )]['margin-top'] = $mobile_dots_bottom_offset_outside;
		}
