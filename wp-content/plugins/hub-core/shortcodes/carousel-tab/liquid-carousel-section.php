...
class WPBakeryShortCode_Ld_carousel_section extends WPBakeryShortCode_VC_Tta_Section {
	/**
	 * @param $width
	 * @param $i
	 *
...
* LD_Shortcode
*/
class LD_Carousel_Section extends LD_Shortcode {
	...
	public function __construct() {
		...
		$this->as_child      = array( 'only' => 'ld_carousel_tab' );
