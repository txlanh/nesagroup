...
<div class="lqd-pb-column col-md-4">
	<div id="<?php echo $this->get_id() ?>" class="<?php echo $this->get_id(); ?> lqd-pb lqd-pb-style-1 lqd-pb-shaped lqd-pb-circle text-center">
		...
		<div class="lqd-pb-content px-md-6">
			...
			<?php $this->get_title( 'font-weight-medium mt-0 mb-2 h5' ); ?>
			<?php $this->get_content(); ?>

		</div><!-- /.lqd-pb-content -->
	</div><!-- /.lqd-pb lqd-pb-style-1 -->
</div><!-- /.lqd-pb-column col-md-4 -->