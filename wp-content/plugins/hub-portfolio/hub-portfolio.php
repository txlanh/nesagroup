<?php
/*
Plugin Name: Hub Portfolio
Plugin URI: http://landingjhub.liquid-themes.com/
Description: Modern and Diversified Portfolio Plugin, exclusively Hub WordPress Theme.
Version: 1.0.2
Author: Liquid Themes
Author URI: https://themeforest.net/user/liquidthemes
Text Domain: landinghub-portfolio
*/
...
class Liquid_Portfolio {
	...
	public function load_plugin_textdomain() {
		...
		load_plugin_textdomain( 'landinghub-portfolio', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
	}
	...
	?>
		<div class="updated not-h2">
			<p><strong><?php esc_html_e( 'Please activate the HUB Core to use the HUB Portfolio plugin.', 'ave-portfolio' ); ?></strong></p>
			<?php
				$screen = get_current_screen();
				if ($screen -> base != 'plugins'):
			?>
				<p><a href="<?php echo esc_url( admin_url( 'plugins.php' ) ); ?>"><?php esc_html_e( 'Activate HUB Core', 'ave-portfolio' ); ?></a></p>
			<?php endif; ?>
		</div>
	<?php
	}
